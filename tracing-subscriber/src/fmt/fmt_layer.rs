    ...
    N: for<'writer> FormatFields<'writer> + 'static,
{
    ...
    pub fn with_extra_fields(self, display_extra_fields: bool) -> Layer<S, N, format::Format<L, T>, W> {
        Layer {
...
impl<S, N, E, W> Layer<S, N, E, W> {
    ...
    pub fn extra_fields(self, fields: &[(&'static str, &'static str)]) -> Layer<S, N, E, W> {
        Layer {
            fmt_event: self.fmt_event,
            fmt_fields: self.fmt_fields,
            fmt_span: self.fmt_span,
